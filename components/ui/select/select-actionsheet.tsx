...
const actionsheetContentStyle = tva({
  base: 'bg-background-0 web:pointer-events-auto web:select-none pb-safe items-center rounded-tl-3xl rounded-tr-3xl p-2 shadow-lg',
});
...
const actionsheetBackdropStyle = tva({
  base: 'bg-background-dark web:cursor-default web:pointer-events-auto absolute top-0 right-0 bottom-0 left-0',
});
